        ...
        <Container maxW="container.xl">
          <VStack spacing={6} textAlign="center">
            ...
            <Text fontSize={{ base: 'lg', md: 'xl' }} maxW="2xl" opacity={0.9}>
              Book lessons with certified instructors in your area. View real-time availability,
          ...
          <VStack spacing={12}>
            <VStack spacing={4} textAlign="center">
              ...
              <Text color="gray.600" maxW="2xl">
                We connect learners with qualified driving instructors, making it easy to book
                lessons and start your journey to independence.
              </Text>
            </VStack>
      ...
      <Box bg="gray.50" py={{ base: 12, md: 16 }}>
        <Container maxW="container.xl">
          <VStack spacing={6} textAlign="center">
            ...
            <Button as={Link} href="/search" size="lg" colorScheme="primary">
        ...
        <Container maxW="container.xl">
          <SimpleGrid columns={{ base: 1, md: 4 }} spacing={8}>
            <VStack align="start" spacing={4}>
              ...
              <Text fontSize="sm">The modern way to find and book driving lessons.</Text>
            </VStack>
...
function FeatureCard({
  ...
  return (
    <VStack
      ...
      spacing={4}
    >
      <Box p={6} bg="primary.50" borderRadius="lg" color="primary.500">
        <Icon as={icon} boxSize={{ base: 16, md: 20 }} strokeWidth={2.5} />
      </Box>
      <VStack align="start" spacing={2}>
